...
def myModel():
    model= Sequential() 
    model.add((Conv2D(32, (5,5),input_shape=(imageDimesions[0],imageDimesions[1],1),activation='relu')))  # ADDING MORE CONVOLUTION LAYERS = LESS FEATURES BUT CAN CAUSE ACCURACY TO INCREASE 
...
# pickle_out= open("model_trained7.p","wb")  # wb = WRITE BYTE
